...
const BAR = [
  ...
  },
  {
    id: 'bar-fresh', name: 'Фреш 0.33', color: '#f9fafb', img: '', items: [
      { n: 'Яблочный фреш', p: 2800 },
      { n: 'Апельсиновый фреш', p: 2800 },
      { n: 'Морковный фреш', p: 2800 },
      { n: 'Цитрусовый фреш', p: 2800 },
    ]
  },
  {
...
try {
  ...
  i18n.menu.items['bar-fresh'] = {
    'Яблочный фреш': { ru: 'Яблочный фреш', kk: 'Алма фреші', en: 'Fresh apple juice' },
    'Апельсиновый фреш': { ru: 'Апельсиновый фреш', kk: 'Апельсин фреші', en: 'Fresh orange juice' },
    'Морковный фреш': { ru: 'Морковный фреш', kk: 'Сәбіз фреші', en: 'Fresh carrot juice' },
    'Цитрусовый фреш': { ru: 'Цитрусовый фреш', kk: 'Цитрус фреші', en: 'Fresh citrus juice' }
  };
