...
const MENU = [
  { id: 'cold', name: 'Холодные закуски', color: '#e6f4ea', items: [
  ...
  { id: 'hot-app', name: 'Горячие закуски', color: '#fff1e6', items: [
  ...
  { id: 'beer', name: 'Пивные сеты', color: '#ffe7ea', items: [
  ...
  { id: 'salads', name: 'Салаты', color: '#efe9ff', items: [
  ...
  { id: 'warm-salads', name: 'Тёплые салаты', color: '#fff8e1', items: [
  ...
  { id: 'soups', name: 'Супы', color: '#e6f3ff', items: [
  ...
  { id: 'pasta', name: 'Пасты', color: '#f3f4f6', items: [
  ...
  { id: 'korean', name: 'Корейская кухня', color: '#ffe4e6', items: [
    { n:'Том-ям', p:3800 },
  ...
  { id: 'k-salads', name: 'Корейские салаты', color: '#fde68a', items: [
    { n:'Хе из баранины', p:3200 },
    { n:'Хе из требухи', p:2800 },
    { n:'Хе из рыбы', p:2400 },
  ]},
  { id: 'grill-meat', name: 'Гриль-блюдо мясо', color: '#dcfce7', items: [
  ...
  { id: 'grill-fish', name: 'Гриль-блюдо рыба', color: '#cffafe', items: [
  ...
  { id: 'hot-main', name: 'Горячие блюда', color: '#fee2e2', items: [
  ...
  { id: 'bird', name: 'Блюдо из птицы', color: '#e5e7eb', items: [
  ...
  { id: 'pizza', name: 'Пицца', color: '#e0e7ff', items: [
  ...
  { id: 'burgers', name: 'Бургеры', color: '#fae8ff', items: [
  ...
  { id: 'kids', name: 'Детское меню', color: '#fef3c7', items: [
    { n:'Наггетсы', p:2800 },
    { n:'Сырные палочки', p:2000 },
    { n:'Котлеты с пюре', p:2000 },
  ]},
  { id: 'breakfast', name: 'Завтраки', color: '#ecfeff', items: [
  ...
  { id: 'preorder', name: 'Блюда на заказ', color: '#f1f5f9', items: [
  ...
  { id: 'sides', name: 'Гарниры', color: '#fdf2f8', items: [
    { n:'Фри', p:1000 },
  ...
  { id: 'desserts', name: 'Десерты', color: '#f0f9ff', items: [
    { n:'Тирамису', p:2000 },
  ...
  { id: 'bread', name: 'Хлебные изделия', color: '#ede9fe', items: [
