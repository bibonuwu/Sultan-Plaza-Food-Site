...
const MENU = [
  ...
  items: [
    ...
    // 22.2 Игристые вина
    { n:'Campo Viejo CAVA Brut Reserva 0,75 л', p:19000 },
    { n:'JACOB\'s Creek Sparking Moscato 0,75 л', p:15000 },
    { n:'JACOB\'s Creek Sauvignon Blanc 0,75 л', p:12000 },
    { n:'Martini Prosecco 0,75 л', p:18000 },
    { n:'Martini Asti 0,75 л', p:18000 },

    // 22.3 Текила
    { n:'Olmeca Blanco 50 мл', p:1500 },
    { n:'Olmeca Gold 50 мл', p:1500 },

    // 22.4 Джин
    { n:'Beefeater Original 50 мл', p:1200 },
    { n:'Beefeater Pink Strawberry 50 мл', p:1200 },

    // 22.5 Кубинский ром
    { n:'Havana Club 3 y.o. 50 мл', p:1600 },
    { n:'Havana Club 7 y.o. 50 мл', p:3000 },
    { n:'Havana Club Especial 50 мл', p:2000 },
    { n:'Havana Club Cuban Spiced 50 мл', p:2200 },

    // … аналогично можно добавить все вина, виски, ликеры и т.д.
    // Чтобы не перегружать массив, рекомендую группировать по подразделам

    // 22.17 Пиво (пример)
    { n:'Miller 0,33 л (бутылочное)', p:1800 },
    { n:'Heineken 0,33 л (бутылочное)', p:1700 },
    { n:'Corona Extra 0,33 л (бутылочное)', p:3500 },
    { n:'Немецкое 0,5 л (разливное)', p:1600 },
    { n:'Дербес «Прага» 0,5 л (разливное)', p:1500 },
    ...
    // 22.22 Чай (пример)
    { n:'Элитный чай — Японская липа (1 л)', p:1800 },
    { n:'Элитный чай — Эрл Грей (1 л)', p:1800 },
    { n:'Авторский чай — Марокканский (1 л)', p:2500 },
    { n:'Авторский чай — Облепиховый (1 л)', p:2500 },

    // 22.24 Напитки
    { n:'Coca-Cola 0,25 л', p:900 },
    { n:'Coca-Cola 1 л', p:1800 },
    { n:'Red Bull 0,25 л', p:1500 },
    { n:'Соки Gracio (ассортимент)', p:2000 },

    // 22.25 Вода
    { n:'Bon Aqua 1 л', p:600 },
    { n:'Borjomi 0,5 л', p:1500 },
    { n:'Tassay 1 л', p:1200 },
  ]
},
];
